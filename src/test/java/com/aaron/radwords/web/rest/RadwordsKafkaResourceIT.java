...
import com.aaron.radwords.RadwordsApp;
...
@SpringBootTest(classes = RadwordsApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class RadwordsKafkaResourceIT {
    ...
    @Autowired
    private RadwordsKafkaProducer producer;

    @Autowired
    private RadwordsKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        RadwordsKafkaResource kafkaResource = new RadwordsKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/radwords-kafka/publish?message=test"))
